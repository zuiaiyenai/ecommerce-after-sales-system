...
from after_sales_agent.infrastructure.agent_metrics import AgentRuntimeMetrics
...
def test_runtime_metrics_record_kafka_review_node_steps() -> None:
    ...
    metrics.record_trace(
        "/kafka/review",
        {
            ...
            "steps": [
                ...
                {"name": "review_policy_skill", "duration_ms": 120},
                {"name": "review_evidence_skill", "duration_ms": 140},
    ...
    assert snapshot["agent_step_latency_ms"]["review_policy_skill"]["max"] == 120
