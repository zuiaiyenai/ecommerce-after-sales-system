...
class StreamingChatService:
    ...
    def __init__(
        ...
        self.chat_service = chat_service or AfterSalesAgent()
    ...
    def stream(
        ...
        handle_chat = getattr(self.chat_service, "handle_chat", None)
        runtime = (
            handle_chat
            if callable(handle_chat)
            else getattr(self.chat_service, "handle")
        )
        result = runtime(payload, trace_recorder=trace_recorder)
